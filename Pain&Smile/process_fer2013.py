...
disgust_path = os.path.join(ck_path, 'disgusted')
fear_path = os.path.join(ck_path, 'fearful')
happy_path = os.path.join(ck_path, 'happy')
sadness_path = os.path.join(ck_path, 'sadness')
surprise_path = os.path.join(ck_path, 'surprised')
...
datafile.create_dataset("data_pixel", dtype = 'uint16', data=data_x)
