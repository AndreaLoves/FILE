...
class unbc(data.Dataset):
    ...
    def __init__(self, split='Training', fold = 1, transform=None):
        ...
        self.data = h5py.File('./data/UNBC_data.h5', 'r', driver='core')
        ...
        sum_number = [0, 1346, 2241]  # the sum of class number
        test_number = [250,180] # the number of each class
