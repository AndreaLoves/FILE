...
class genki(data.Dataset):
    ...
    def __init__(self, split='Training', fold = 1, transform=None):
        ...
        self.data = h5py.File('./data/GENKI_data.h5', 'r', driver='core')
        ...
        sum_number = [0,1832,3999] # the sum of class number
        test_number = [180,210] # the number of each class
        ...
        # now load the pigenkied numpy arrays
