...
trainset = unbc(split = 'Training', fold = opt.fold, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=opt.bs, shuffle=True, num_workers=0)
testset = unbc(split = 'Testing', fold = opt.fold, transform=transform_test)
