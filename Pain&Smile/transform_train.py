...
image_datasets = {
    x: datasets.ImageFolder(
        # root=os.path.join('/user-data/emo_rec/dataset/genki', x),
        root=os.path.join('/home/ouyangqun/emo_rec/emo_rec/dataset/201test', x),
...
# model_ft = ER()
# # # pretrained_dict = torch.load("/home/ouyangqun/emo_rec/emo_rec/dataset/model.pt")
# model_ft.load_state_dict(torch.load('/home/ouyangqun/emo_rec/emo_rec/dataset/params_gebki0308.pkl'))
#
#
...
model_conv.load_state_dict(torch.load('/home/ouyangqun/emo_rec/emo_rec/dataset/all_train_params.pkl'))
...
exp_lr_scheduler = lr_scheduler.StepLR(optimizer_conv, step_size=10, gamma=0.8)
