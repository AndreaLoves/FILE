        ...
        if x[1] is None:
            ...
            if x[1].size()[2]!=x[0].size()[2]:
                ...
                if extent == 1:
                    ...
                    print("pre_spatial_att",pre_spatial_att.shape)

                # print("x0和preatt的hw不一致！！")
                # print("x0.size()", x[nopain].size())
                # print("x1.size()", x[pain].size())
                # print("pre_spatial_att.size()", pre_spatial_att.size())
                # print("over!!")
            else:
                pre_spatial_att = x[1]
            #     print("x0和preatt的hw一致！！")
            #     print("x0.size()", x[nopain].size())
            #     print("x1.size()", x[pain].size())
            #     print("over!!")
            # print("开始计算x_compress!")
            # print("x0.size()", x[nopain].size())
            # print("x1.size()", x[pain].size())
